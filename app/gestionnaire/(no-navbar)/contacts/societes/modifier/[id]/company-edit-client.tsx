...
export function CompanyEditClient({ company, teamId }: CompanyEditClientProps) {
    ...
    const form = useForm<CompanyFormData>({
        ...
        defaultValues: {
            ...
            email: company.email || '',
            phone: company.phone || '',
            street: company.address_record?.street || '',
            street_number: '', // Not stored separately in addresses table
            postal_code: company.address_record?.postal_code || '',
            city: company.address_record?.city || '',
            country: company.address_record?.country || 'BE',
