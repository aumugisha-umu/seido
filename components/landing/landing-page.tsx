        ...
        <div className="min-h-screen bg-[#0f172a] text-white overflow-hidden selection:bg-purple-500 selection:text-white">
            ...
            <section className="relative z-10 container mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                    <div className="p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm">
                        ...
                        <h3 className="text-lg font-bold text-white mb-2">Communication chaotique</h3>
                    ...
                    <div className="p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm">
                        ...
                        <h3 className="text-lg font-bold text-white mb-2">Perte de temps monstre</h3>
                        <p className="text-sm text-white/60">
                    ...
                    <div className="p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm">
                        ...
                        <h3 className="text-lg font-bold text-white mb-2">Locataires insatisfaits</h3>
                        <p className="text-sm text-white/60">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                ...
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Demandes centralisées</h3>
                                    <p className="text-sm text-white/60">
                            ...
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Coordination automatisée</h3>
                                    <p className="text-sm text-white/60">
                            ...
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Transparence totale</h3>
                                    <p className="text-sm text-white/60">
                        ...
                        <div className="space-y-4">
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Historique complet</h3>
                                    <p className="text-sm text-white/60">
                            ...
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Notifications intelligentes</h3>
                                    <p className="text-sm text-white/60">
                            ...
                            <div className="flex gap-3">
                                <CheckCircle2 className="w-6 h-6 text-green-400 flex-shrink-0 mt-1" />
                                <div>
                                    <h3 className="font-semibold text-white mb-1">Reporting simplifié</h3>
                                    <p className="text-sm text-white/60">
            ...
            <section className="relative z-10 container mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
                    <div className="text-center space-y-3">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white flex items-center justify-center text-xl font-bold mx-auto">
                            1
                        </div>
                        <h3 className="font-semibold text-white">Créez votre compte</h3>
                        <p className="text-sm text-white/60">
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <h3 className="font-semibold text-white">Invitez vos équipes</h3>
                        <p className="text-sm text-white/60">
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <h3 className="font-semibold text-white">Gérez les demandes</h3>
                        <p className="text-sm text-white/60">
                    ...
                    <div className="text-center space-y-3">
                        ...
                        <h3 className="font-semibold text-white">Gagnez du temps</h3>
                        <p className="text-sm text-white/60">
            ...
            <section id="features" className="relative z-10 container mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="group p-8 rounded-3xl border border-white/5 bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all duration-300 hover:-translate-y-1">
            ...
            <section id="roles" className="relative z-10 container mx-auto px-4 py-24">
                <div className="grid md:grid-cols-3 gap-8">
                    ...
                    {/* Prestataire */}
                    <div className="relative group rounded-3xl overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-b from-green-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        <div className="relative p-8 bg-[#1e293b]/50 border border-white/10 backdrop-blur-md h-full">
                    ...
                    {/* Locataire */}
                    <div className="relative group rounded-3xl overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-b from-orange-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                        <div className="relative p-8 bg-[#1e293b]/50 border border-white/10 backdrop-blur-md h-full">
                            <Home className="w-10 h-10 text-orange-400 mb-6" />
            ...
            <section className="relative z-10 container mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="p-8 rounded-3xl border border-white/5 bg-white/5 backdrop-blur-sm">
            ...
            <section id="pricing" className="relative z-10 container mx-auto px-4 py-24">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                    {/* Mensuel */}
                    <div className="p-8 rounded-3xl border border-white/10 bg-[#1e293b]/50 backdrop-blur-md hover:bg-[#1e293b]/70 transition-colors flex flex-col">
                        ...
                        <Button className="w-full bg-white/10 hover:bg-white/20 text-white border-0 mt-auto">
                            Choisir Mensuel
                        </Button>
                    </div>

                    {/* Annuel - Glowing */}
                    <div className="relative p-8 rounded-3xl bg-[#1e293b]/80 backdrop-blur-md border border-purple-500/50 shadow-[0_0_40px_rgba(168,85,247,0.15)] flex flex-col">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full text-xs font-bold text-white uppercase tracking-wider">
                            Populaire
                        </div>
                        ...
                        <Button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 border-0 shadow-lg shadow-purple-500/25 mt-auto">
                            Choisir Annuel
                        </Button>
                    </div>
                </div>
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6 h-full flex flex-col">
                            <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm flex items-start gap-4">
