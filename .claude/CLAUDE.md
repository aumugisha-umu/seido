...
**Applied automatically during ALL code writing. Prevents issues that /simplify would catch post-hoc.**
...
**Current Focus**: Supplier Contracts + AI Phone Assistant + Content Marketing + Compound Engineering
