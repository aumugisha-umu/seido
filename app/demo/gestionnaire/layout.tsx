/**
 * Layout pour le rôle Gestionnaire en mode démo
...
export default function GestionnaireDemoLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <div className="h-screen bg-gray-50 flex flex-col overflow-hidden pt-[52px]">
        <DemoDashboardHeader role="gestionnaire" />
