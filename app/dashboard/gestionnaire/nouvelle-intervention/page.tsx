...
export default function NouvelleInterventionPage() {
  ...
  const handleSubmit = () => {
    ...
    router.push("/dashboard/gestionnaire/interventions")
  }
  ...
  const handleCreateIntervention = () => {
    ...
    const timer = setInterval(() => {
      setCountdown((prev) => {
        if (prev <= 1) {
          clearInterval(timer)
          router.push(`/dashboard/gestionnaire/interventions/details/${interventionId}`)
          return 0
        }
        return prev - 1
      })
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="flex flex-col space-y-2">
                <Button
                  variant="outline"
                  onClick={() => handleNavigation("/dashboard/gestionnaire")}
                  className="w-full"
                >
                ...
                <Button
                  onClick={() => handleNavigation(`/dashboard/gestionnaire/interventions/details/${interventionId}`)}
                  className="w-full"
                >
