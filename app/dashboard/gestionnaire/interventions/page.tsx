...
export default function InterventionsPage() {
  ...
  const handleFinalConfirmation = () => {
    if (confirmationModal.action === "approve") {
      ...
      setTimeout(() => {
        router.push(`/dashboard/gestionnaire/nouvelle-intervention?${queryParams.toString()}`)
      }, 2000)
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="ml-4 flex flex-col space-y-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => router.push(`/dashboard/gestionnaire/interventions/details/${intervention.id}`)}
                    >
