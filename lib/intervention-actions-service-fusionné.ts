...
export class InterventionActionsService {
  ...
  async rejectIntervention(intervention: InterventionAction, data: ApprovalData): Promise<APIResponse> {
    logger.info(`❌ Rejecting intervention ${intervention.id}`)
   ...
   */
  async cancelIntervention(intervention: InterventionAction, data: CancellationData): Promise<APIResponse> {
