/**
 * Layout pour le rôle Prestataire en mode démo
...
export default function PrestataireDemoLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <div className="h-screen bg-gray-50 flex flex-col overflow-hidden pt-[52px]">
        <DemoDashboardHeader role="prestataire" />
