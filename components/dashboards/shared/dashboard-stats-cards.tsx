...
export function DashboardStatsCards({
    ...
    return (
        <div className={cn(
            ...
            {isManager && (
                <Card className="dashboard-stats-cards__card dashboard-stats-cards__card--buildings bg-white border-none shadow-sm hover:shadow-md transition-all duration-300 hover:transform hover:-translate-y-1 rounded-2xl overflow-hidden group">
                    <CardContent className="dashboard-stats-cards__content p-6 relative">
                        <div className="dashboard-stats-cards__icon-bg absolute right-0 top-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Building2 className="h-24 w-24 text-indigo-600" />
                        </div>
                        <div className="dashboard-stats-cards__info relative z-10">
                            <p className="dashboard-stats-cards__label text-sm font-medium text-slate-500 uppercase tracking-wider">Patrimoine</p>
                            <div className="dashboard-stats-cards__value-container flex items-baseline gap-2 mt-2">
                                <span className="dashboard-stats-cards__value text-4xl font-bold text-slate-900">{buildingsCount}</span>
                                <span className="dashboard-stats-cards__sublabel text-sm text-slate-400 flex items-center gap-1">
            ...
            {isManager && occupancyRate !== undefined && (
                <Card className="dashboard-stats-cards__card dashboard-stats-cards__card--occupancy bg-white border-none shadow-sm hover:shadow-md transition-all duration-300 hover:transform hover:-translate-y-1 rounded-2xl overflow-hidden group">
                    <CardContent className="dashboard-stats-cards__content p-6 relative">
                        <div className="dashboard-stats-cards__icon-bg absolute right-0 top-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                            <Users className="h-24 w-24 text-emerald-600" />
                        </div>
                        <div className="dashboard-stats-cards__info relative z-10">
                            <p className="dashboard-stats-cards__label text-sm font-medium text-slate-500 uppercase tracking-wider">Occupation</p>
                            <div className="dashboard-stats-cards__value-container flex items-baseline gap-2 mt-2">
                                <span className="dashboard-stats-cards__value text-4xl font-bold text-slate-900">{occupancyRate}%</span>
            ...
            <Card className="dashboard-stats-cards__card dashboard-stats-cards__card--active bg-white border-none shadow-sm hover:shadow-md transition-all duration-300 hover:transform hover:-translate-y-1 rounded-2xl overflow-hidden group">
                <CardContent className="dashboard-stats-cards__content p-6 relative">
                    <div className="dashboard-stats-cards__icon-bg absolute right-0 top-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                        <Wrench className="h-24 w-24 text-blue-600" />
                    </div>
                    <div className="dashboard-stats-cards__info relative z-10">
                        <p className="dashboard-stats-cards__label text-sm font-medium text-slate-500 uppercase tracking-wider">En cours</p>
                        <div className="dashboard-stats-cards__value-container flex items-baseline gap-2 mt-2">
                            <span className="dashboard-stats-cards__value text-4xl font-bold text-blue-600">{activeCount}</span>
                            <span className="dashboard-stats-cards__sublabel text-sm text-slate-400">interventions</span>
                        </div>
                    </div>
                </CardContent>
            </Card>
            ...
            {!isManager && completedCount !== undefined && (
                <Card className="dashboard-stats-cards__card dashboard-stats-cards__card--completed bg-white border-none shadow-sm hover:shadow-md transition-all duration-300 hover:transform hover:-translate-y-1 rounded-2xl overflow-hidden group">
                    <CardContent className="dashboard-stats-cards__content p-6 relative">
                        <div className="dashboard-stats-cards__icon-bg absolute right-0 top-0 p-6 opacity-10 group-hover:opacity-20 transition-opacity">
                            <CheckCircle2 className="h-24 w-24 text-green-600" />
                        </div>
                        <div className="dashboard-stats-cards__info relative z-10">
                            <p className="dashboard-stats-cards__label text-sm font-medium text-slate-500 uppercase tracking-wider">Terminées</p>
                            <div className="dashboard-stats-cards__value-container flex items-baseline gap-2 mt-2">
