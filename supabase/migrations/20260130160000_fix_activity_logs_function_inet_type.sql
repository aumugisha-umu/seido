-- Fix: Change ip_address return type from TEXT to INET
-- The activity_logs.ip_address column is INET, not TEXT
...
RETURNS TABLE (
  ...
  metadata JSONB,
  error_message TEXT,
  ip_address INET,  -- FIX: Changed from TEXT to INET
  user_agent TEXT,
...
FIX v2: ip_address type changed from TEXT to INET.';
