...
import {
  ...
  createContactService, // ✅ Browser Service (compatible Client Component)
  createBuildingService, // ✅ Browser Service
  createLotService, // ✅ Browser Service
  createInterventionService, // ✅ Browser Service
...
export default function ContactDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // ✅ Initialize Browser Services (compatible avec Client Components)
  ...
  const [interventionService] = useState(() => createInterventionService())
