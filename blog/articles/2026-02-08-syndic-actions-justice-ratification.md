...
infographic:
  type: "flow-tree"
  data:
    title: "Action en justice du syndic : ratification AG"
    nodes:
      - id: "q1"
        label: "Action en justice envisagee ?"
        type: "question"
      - id: "q2"
        label: "Urgence ou mesure conservatoire ?"
        type: "question"
      - id: "a1"
        label: "Ratification prealable en AG"
        type: "action"
      - id: "r1"
        label: "Syndic peut agir — ratifier apres"
        type: "result"
      - id: "q3"
        label: "Recouvrement de charges ?"
        type: "question"
      - id: "r2"
        label: "Action recevable"
        type: "result"
      - id: "r3"
        label: "Gestion courante — pas de ratification"
        type: "result"
      - id: "r4"
        label: "Irrecevabilite + responsabilite syndic"
        type: "warning"
    edges:
      - from: "q1"
        to: "q2"
      ...
      - from: "a1"
        to: "r4"
        label: "Pas de ratification"
        type: "no"
---

# Syndic et actions en justice : pourquoi l'assemblee generale doit toujours ratifier
...
> A lire aussi : [Vices caches en copropriete : l'arret de la Cour de cassation](/blog/vices-caches-copropriete-cassation) — [Fibre optique en copropriete : droits et obligations du syndic](/blog/fibre-optique-copropriete).

---

## Sources et references

- Article 3.92 du Code civil belge (ancien article 577-9 §1) — pouvoirs d'agir du syndic au nom de l'ACP
- [Droit d'agir de la copropriete](https://copropriete-ejuris.be/droit-dagir/), copropriete-ejuris.be
- [La recuperation des arrieres de charges de copropriete](https://www.actualitesdroitbelge.be/droit-immobilier/abreges-juridiques/la-recuperation-des-arrieres-de-charges-de-copropriete/la-recuperation-des-arrieres-de-charges-de-copropriete), ActualitesDroitBelge.be
