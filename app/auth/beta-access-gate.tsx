 ...
 *
 * Two access modes:
 * 1. Request access (default): Simplified form to join the waitlist
 * 2. Access code: Direct entry for invited users
 */
...
const valueProps = [
  ...
  {
    icon: HeadphonesIcon,
    title: 'Onboarding dédié',
    description: 'Configuration assistée et formation incluse',
  },
  {
    icon: Sparkles,
    title: 'Accès complet',
    description: 'Toutes les fonctionnalités dès le premier jour',
  },
]
  ...
  return (
    <div className="fixed inset-0 z-20 bg-landing-bg overflow-y-auto">
      ...
      <div className="min-h-full flex items-center justify-center p-4 py-8">
        <div className={`w-full relative z-10 px-4 transition-all duration-300 ${activeTab === 'password' ? 'max-w-lg' : 'max-w-5xl'}`}>
          {/* Logo SEIDO */}
          ...
          {/* Main card */}
          <div className="w-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
                    ...
                    <form action={interestAction} className="flex-1 flex flex-col gap-4">
                      ...
                      <div className="flex-1 flex flex-col">
                        <Label htmlFor="message" className="text-white text-sm">
                          Parlez-nous de votre activité <span className="text-white/40">(optionnel)</span>
                        </Label>
                        <Textarea
                          id="message"
                          name="message"
