...
infographic:
  type: "flow-tree"
  data:
    title: "Controle du syndic : qui verifie quoi ?"
    nodes:
      - id: "q1"
        label: "Decision du syndic ?"
        type: "question"
      - id: "q2"
        label: "Depasse le mandat courant ?"
        type: "question"
      - id: "a1"
        label: "Execution autonome"
        type: "action"
      - id: "a2"
        label: "Soumettre a l'AG"
        type: "action"
      - id: "q3"
        label: "Controle comptable ?"
        type: "question"
      - id: "r1"
        label: "Commissaire aux comptes"
        type: "result"
      - id: "r2"
        label: "Conseil de copropriete (20+ lots)"
        type: "result"
      - id: "r3"
        label: "Responsabilite personnelle du syndic"
        type: "warning"
    edges:
      - from: "q1"
        to: "q2"
...
# Syndic de copropriete : ce que vous etes en droit d'exiger — 30 ans apres la loi fondatrice
...
Il est obligatoire a partir de 20 lots (hors caves, garages et parkings). En dessous de ce seuil, il peut etre constitue de facon facultative.

**Quel est son role ?**
Contrairement au commissaire aux comptes qui ne controle que la comptabilite, le conseil de copropriete **controle l'ensemble des missions du syndic** : technique, comptable ET administrative. Il peut demander des explications au syndic, consulter tous les documents de la copropriete, et formuler des recommandations a l'assemblee generale.
...
> A lire aussi : [PEB a Bruxelles : les coproprietaires bientot co-responsables des passoires energetiques](/blog/peb-bruxelles-copropriete-amendes).
