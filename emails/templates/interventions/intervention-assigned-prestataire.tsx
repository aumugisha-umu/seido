...
InterventionAssignedPrestataireEmail.PreviewProps = {
  ...
  lotReference: 'Apt 3B',
  interventionUrl: 'https://seido-app.com/prestataire/interventions/INT-2024-042',
  ...
  slotActions: [
    {
      ...
      startTime: '09:00',
      endTime: '12:00',
      acceptUrl: 'https://seido-app.com/auth/email-callback?token_hash=xxx&action=accept_time_slot&param_slotId=slot-001',
    ...
    },
    {
      ...
      startTime: '14:00',
      endTime: '17:00',
      acceptUrl: 'https://seido-app.com/auth/email-callback?token_hash=xxx&action=accept_time_slot&param_slotId=slot-002',
