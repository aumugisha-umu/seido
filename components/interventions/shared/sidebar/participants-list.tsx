      ...
      <div className="space-y-6">
        {visibleParticipants.managers.length > 0 && (
          <ParticipantGroup
            ...
            role="manager"
            showConversationButtons={canShowConversationButtons && permissions.canChatWithRole(currentUserRole, 'manager')}
        ...
        {visibleParticipants.providers.length > 0 && (
          <ParticipantGroup
            ...
            role="provider"
            showConversationButtons={canShowConversationButtons && permissions.canChatWithRole(currentUserRole, 'provider')}
            activeConversation={activeConversation}
            onConversationClick={onConversationClick}
            onParticipantClick={onParticipantClick}
            assignmentMode={assignmentMode}
        ...
        {visibleParticipants.tenants.length > 0 && (
          <ParticipantGroup
            ...
            role="tenant"
            showConversationButtons={canShowConversationButtons && permissions.canChatWithRole(currentUserRole, 'tenant')}
            activeConversation={activeConversation}
            onConversationClick={onConversationClick}
            onParticipantClick={onParticipantClick}
