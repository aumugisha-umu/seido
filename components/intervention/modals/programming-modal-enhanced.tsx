              ...
              <div className="animate-in slide-in-from-top-2 duration-300">
                ...
                {programmingOption === "direct" && (
                  <div className="space-y-4">
                    ...
                    <div className="grid gap-4 p-4 bg-sky-50/30 border border-sky-200 rounded-lg">
                      <div>
                        ...
                        <div key={index} className="p-4 bg-white border border-slate-200 rounded-lg space-y-3">
                          ...
                          <div className="grid gap-3">
                            <input
                              ...
                              className="w-full px-3 py-1.5 text-sm border border-slate-300 rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500"
                            />
