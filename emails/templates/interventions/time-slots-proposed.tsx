  ...
  slotActions: [
    {
      ...
      startTime: '09:00',
      endTime: '11:00',
      acceptUrl: 'https://seido-app.com/auth/email-callback?token_hash=xxx&action=confirm_slot&param_slotId=slot-001',
      refuseUrl: 'https://seido-app.com/auth/email-callback?token_hash=yyy&action=reject_slot&param_slotId=slot-001',
    },
    {
      slotId: 'slot-002',
      ...
      startTime: '14:00',
      endTime: '16:00',
      acceptUrl: 'https://seido-app.com/auth/email-callback?token_hash=xxx&action=confirm_slot&param_slotId=slot-002',
      refuseUrl: 'https://seido-app.com/auth/email-callback?token_hash=yyy&action=reject_slot&param_slotId=slot-002',
    },
    {
      slotId: 'slot-003',
      ...
      startTime: '10:00',
      endTime: '12:00',
      acceptUrl: 'https://seido-app.com/auth/email-callback?token_hash=xxx&action=confirm_slot&param_slotId=slot-003',
      refuseUrl: 'https://seido-app.com/auth/email-callback?token_hash=yyy&action=reject_slot&param_slotId=slot-003',
    },
  ],
