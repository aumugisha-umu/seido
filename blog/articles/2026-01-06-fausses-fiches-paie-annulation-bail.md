...
1. **Des manoeuvres frauduleuses** : la production de faux documents est une manoeuvre frauduleuse
2. **Un caractere intentionnel** : le locataire savait que les documents etaient faux
3. **Un lien de causalite** : sans ces faux documents, le bailleur n'aurait pas signe le bail
...
- Banque-Carrefour des Entreprises (BCE) — [kbopublic.economie.fgov.be](https://kbopublic.economie.fgov.be)
