...
export interface UseInterventionTypesOptions {
   ...
   * @see lib/services/domain/intervention-types.server.ts for getInterventionTypesServer()
   */
...
// ============================================================================
// Server-side Function - MOVED
// ============================================================================

/**
 * For Server Components, use the dedicated server file instead:
 *
 * @see lib/services/domain/intervention-types.server.ts
 *
 * This separation is required because SWR accesses `window` at module import time,
 * which breaks Server Components that import this file.
 *
 * @example
 * ```tsx
