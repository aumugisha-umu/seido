...
| Echeance | Objectif | Consequence |
|----------|----------|-------------|
| **2033** (indicatif) | Fin des certificats F et G | Amende si > 275 kWh/m²/an |
| **2043** (indicatif) | Fin des certificats D et E | Amende si > 150 kWh/m²/an |
...
| Region / Pays | Taux max en ligne directe (a partir de 250.000 EUR) | Taux max sans parente proche |
|---|---|---|
...
En dessous de **250.000 EUR par enfant**, la taxation reste raisonnable (7-10%). Inutile de se precipiter dans des donations.

**2. Demenager en Wallonie**
Le decret du 5 decembre 2024 reduit les droits de succession de moitie a partir du 1er janvier 2028. Bonne nouvelle : la condition de residence de 5 ans dans la region a ete supprimee, facilitant la planification successorale.

**3. Proteger son conjoint avec un contrat de mariage mixte**
Le contrat ideal : **separation de biens** (regime de base) + **communaute accessoire limitee** (epargne commune). Cela permet de transmettre la residence principale au survivant sans droits de succession via un testament adequat.

**4. Renoncer a la succession en faveur des petits-enfants**
Le "saut de generation" est desormais possible dans les trois regions. Pour une succession de 500.000 EUR :

| Scenario | Wallonie 2025-2027 | Wallonie 2028+ |
|---|---|---|
| Sans renonciation (1 enfant) | 86.625 EUR | 42.250 EUR |
| Avec renonciation (2 petits-enfants) | 53.250 EUR | **25.500 EUR** |

**5. Le fidei-commis dans le testament**
Pour les familles avec plusieurs enfants : leguer une premiere fois a tous les enfants, puis prevoir que les biens d'un enfant decede sans descendance reviennent aux autres enfants (taxation en ligne directe, pas entre freres/soeurs).

**6. Le legs "en duo"**
Technique applicable a **Bruxelles et en Wallonie** : designer une ASBL comme legataire universel, qui prend en charge les droits de succession et remet ~50% net aux personnes designees dans le testament (au lieu de 20-30% apres taxation a 70-80%).

**7. Donations immobilieres tous les 3 ans**
Malgre le passage du delai de reprise des dons manuels a 5 ans, le delai entre deux **donations immobilieres** reste a **3 ans**. Il est donc possible de "saucissonner" un immeuble en donations successives pour beneficier des taux les plus bas.
...
> **A lire aussi** : notre [article de fevrier 2026](/blog/immobilier-belgique-fevrier-2026) couvre la grille des loyers, le precompte immobilier et les renovations energetiques en copropriete.
...
- Ordonnance du 7 mars 2024 modifiant le Code bruxellois de l'Air, du Climat et de la Maitrise de l'Energie ([CoBrACE](https://etaamb.openjustice.be/fr/ordonnance-du-07-mars-2024_n2024002045.html)), *M.B., 22 mars 2024*
- Arretes du 3 juillet 2025 — Expert PEB, Indicateurs et Exigences, Certificat Unique ([Info Fiche Bruxelles Environnement](https://document.environnement.brussels/opac_css/elecfile/Reforme_PEB_Transition_Expert_PEB))
- [Fin programmee du bati energivore en Region bruxelloise](https://environnement.brussels/pro/news/2024/fin-programmee-du-bati-energivore-en-region-bruxelloise), Bruxelles Environnement, 2024
- [Brussels renovation obligation approved by Parliament](https://www.loyensloeff.com/insights/news--events/news/brussels-renovation-obligation-approved-by-parliament/), Loyens & Loeff, 2024
...
- Ordonnance du 22 juin 2023 modifiant le Code bruxellois du Logement en matiere de contentieux locatif et d'expulsion, *M.B., 2023*
- [Moratoire hivernal — demande d'indemnisation](https://be.brussels/en/housing/rental/eviction-and-lease-termination/winter-moratorium-compensation-how-apply), be.brussels
- [Bailleurs, avez-vous ete victimes du moratoire hivernal ?](https://www.snpc-nems.be/news/articles/region-de-bruxelles-capitale-bailleurs-avez-vous-ete-victimes-du-moratoire-hivernal), SNPC, 2024
- [La Cour constitutionnelle confirme le moratoire hivernal bruxellois](https://monardlaw.be/fr/histoires/informe/grondwettelijk-hof-bevestigt-brusselse-winterstop-bij-uithuiszettingen/), Monard Law, 2024

### 4. Arret CEDH — Wulffaert

- Wulffaert & Wulffaert Beheer NV c. Belgique, CEDH, 10 juillet 2025 — violation de l'article 7 ECHR (lex mitior)
- [EHRM veroordeelt Belgie voor schending artikel 7 EVRM](https://www.auriusadvocaten.be/nieuws/ehrm-veroordeelt-belgie-voor-schending-artikel-7-evrm-bij-toepassing-vrijstellingsbesluit), Aurius Advocaten, juillet 2025
- Texte integral : [HUDOC](https://hudoc.echr.coe.int/) (recherche "Wulffaert Belgium")

### 5. Loi copropriete

- [Loi du 30 juin 1994 modifiant et completant les dispositions du Code civil relatives a la copropriete](https://refli.be/en/lex/1994009545), *M.B., 26 juillet 1994*
- Loi du 2 juin 2010 (modernisation) et Loi du 18 juin 2018 (reforme complementaire)

### 6. Fausses fiches de paie

- J.P. Lennik, 31 janvier 2024 (inedit) — annulation du bail pour dol (fausses fiches de paie)
- [Bailleurs, attention aux fausses fiches de paie](https://crm.snpc-nems.be/fr/content/bailleurs-attention-aux-fausses-fiches-de-paie), SNPC, 2024
...
- [Guide complet donation immobiliere Belgique par region](https://gestiplus.be/dossiers/donation-immobiliere/), Gestiplus, 2024
