...
infographic:
  type: "flow-tree"
  data:
    title: "Installation fibre optique : decision du syndic"
    nodes:
      - id: "q1"
        label: "Demande d'acces operateur ?"
        type: "question"
      - id: "q2"
        label: "Infrastructure existante ?"
        type: "question"
      - id: "a1"
        label: "Donner acces au local technique"
        type: "action"
      - id: "r1"
        label: "Mutualisation — 2e operateur reutilise"
        type: "result"
      - id: "q3"
        label: "Nouvelle infra interne necessaire ?"
        type: "question"
      - id: "r2"
        label: "Acces obligatoire (droit legal)"
        type: "result"
      - id: "r3"
        label: "Syndic peut refuser — vote AG"
        type: "warning"
    edges:
      - from: "q1"
        to: "q2"
...
# Fibre optique en copropriete : ce que le syndic peut et ne peut pas faire
...
> A lire aussi : [Renovation energetique en copropriete : les vrais chiffres](/blog/renovation-energetique-copropriete-chiffres) — [Syndic et actions en justice : quand faut-il l'accord de l'AG ?](/blog/syndic-actions-justice-ratification).

---

## Sources et references

- Loi du 13 juin 2005 relative aux communications electroniques (Telecom Act belge)
